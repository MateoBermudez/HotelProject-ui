...
const PaymentPage = () => {
    ...
    const getPaymentAmount = () => {
        switch (paymentOption) {
            ...
            case "partial":
                return bookingData.totalAmount * 0.5 // 50% partial payment
            case "postpaid":
                return bookingData.totalAmount * 0.15 // 15% deposit for postpaid
            default:
                return bookingData.totalAmount
        }
    }
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                ...
                                <div className="flex items-start space-x-4 mb-6">
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900">{bookingData.roomName}</h3>
                                ...
                                <div className="space-y-4 mb-6">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">{formatDate(bookingData.checkInDate)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-3">
                                        <Calendar className="h-5 w-5 text-teal-600" />
                                        <div>
                                            ...
                                            <p className="text-gray-600">{formatDate(bookingData.checkOutDate)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-600">
                        ${bookingData.roomPrice} × {bookingData.nights} nights
                                            ...
                                            <span>${(bookingData.roomPrice * bookingData.nights).toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span className="font-semibold text-teal-600">${bookingData.totalAmount.toFixed(2)}</span>
                                                </div>
                            ...
                            ${(bookingData.totalAmount * 0.5).toFixed(2)}
                          </span>
                                                </div>
                                        ...
                                        <label className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span className="font-semibold text-teal-600">
                                                        ${ (bookingData.totalAmount * 0.15).toFixed(2) }
                                                    </span>
                                                </div>
